    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        <%
            ...
            try {
                ...
                String query2="select PAY_TYPE, AMOUNT, DATE from customer_pay where RETAILER=? and YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE())";
                        ...
                        <div class="tab-content">
                            <div id="proinfo" class="tab-pane fade in active"><br>
                                ...
                                <center>
                                    ...
                                    <h4>Current Balance : ${total-(totalpay+dis)}</h4>
                                </center>
