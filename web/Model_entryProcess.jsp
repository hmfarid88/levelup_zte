...
<html>
    ...
    <body>
        <%
            ...
            Float asaletprice = Float.parseFloat(request.getParameter("asaleprice"));
            Float bsaletprice = Float.parseFloat(request.getParameter("bsaleprice"));
            Connection con = null;
            ...
            try {
                ...
                if (a > 0) {
                    ...
                    String query = "insert into model_price (MODEL, PURCHASE_PRICE, A_SALE_PRICE, B_SALE_PRICE)  values (?,?,?,?)";
                    ps = con.prepareStatement(query);
                    ps.setString(1, model);
                    ps.setFloat(2, costprice);
                    ps.setFloat(3, asaletprice);
                    ps.setFloat(4, bsaletprice);
