                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            ...
                            <li>
                                <div id="mdateview" class="collapse" style="margin:10px 0px">
                                    <form  method="POST" action="datewise_returned_sale.jsp" class="form-inline">
                    ...
                    <table border="2" width="100%" class="table-condensed table-responsive">
                        <thead>
                            <tr style="background-color: #CCCCCC">
                                ...
                                <th style="text-align: center">Pre Profit</th>
                                <th style="text-align: center">Post  profit</th>
                        ...
                        <tbody id="myTable">
                            <%
                                ...
                                try {
                                    ...
                                    String query = "select * from sale_return where YEAR(BACK_DATE) = YEAR(CURRENT_DATE()) AND MONTH(BACK_DATE) = MONTH(CURRENT_DATE())";
