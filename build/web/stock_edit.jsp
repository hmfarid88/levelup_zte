                                ...
                                <table border="1px" width="70%" class="table-responsive table-condensed">
                                    <%
                                        ...
                                        try {
                                            ...
                                            String query = "select MODEL, COLOR, IMEI, PURCHASE_PRICE, A_SELL_PRICE, B_SELL_PRICE, VENDOR from stock where IMEI=? ";
                                    ...
                                    <tr>
                                        <td>GRT PRICE :</td>
                                        <td><input type="text" class="form-control" name="asprice" value="<%= rs.getFloat("A_SELL_PRICE")%> " required="" ></td>
                                    </tr>
                                    <tr>
                                        <td>MIPP PRICE :</td>
                                        <td><input type="text" class="form-control" name="bsprice" value="<%= rs.getFloat("B_SELL_PRICE")%> " required="" ></td>
                                    </tr>
                                    <tr>
                                        <td>VENDOR :</td>
