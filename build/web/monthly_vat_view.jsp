                    ...
                    <nav style="margin: 0 auto" class="navbar navbar-inverse">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li style="margin: 12px 200px">
                                    <div>
                                        <form action="datewise_vat.jsp" method="POST" class="form-inline">
                                            <label style="color: white">Date-Wise</label>
                                            <input type="date" size="10px" autocomplete="off" class="form-control" name="date1" value="" required="" placeholder="Srart Date" >
                                            <label style="color: white">To</label> <input type="date" size="10px" autocomplete="off" class="form-control" name="date2" value="" required="" placeholder="End Date" >
                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select VAT, INVOICE_NO, DATE from paymentinfo where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) order by DATE ";
