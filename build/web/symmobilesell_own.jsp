            ...
            <div class="panel panel-primary" style=" background-color: #030303; color: #ffffff">
                <nav style="margin: 0 auto" class="navbar navbar-inverse">
                  ...
                  <div class="panel-body">
                    <h3 class="text-center">Own House Distribution</h3>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-6">
                                    <br> 
                                    <form method="POST" action="OhSellServlet" class="form-inline" >
                                ...
                                <br>
                                <div class="col-sm-6">
                                    <form method="POST" action="OhSellServlet">
                                       <input type="hidden" name="cid" value="${iid+1}">
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                            ...
                            <div class="row">
                                ...
                                <table  border="1" width="100%" id="myTables" class="table-responsive ">
                                    ...
                                    <td style="width: 70px">
                                    <center>
                                        <form  method="POST" action="OhMdiscountServlet" class=" form-inline">
                                    ...
                                    <td><center>
                                        <form method="POST" action="OhMsalerolbackServlet">
                        ...
                        <form id="saleform" method="POST" action="PaymentServlet" name="myForm" >
                            ...
                            <div class="col-sm-5">
                                ...
                                <fieldset class="scheduler-border">
                                    <legend style="color:#ffffff" class="scheduler-border">Retailer-Information</legend>
                                    <div class="row">
                                        <div class="col-sm-2"> </div>
                                            <div class="col-sm-8"> 
                                                <label><b>Select Retailer :</b></label><br>
                                                <select  name="customername" class="form-control select2" required="">
                                                    <option value="">Select Retailer</option>
                                                    <%
                                                        try {
                                                con = Database.getConnection();
                                                String query1 = "select R_NAME from retailer_info where GRADE='Own House' ";
