    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fname=request.getParameter("fname");    
            ...
            try {
                ...
                String query1="select count(*) from cost_name where COST_NAME=?";
                        ...
                        int a=rs.getInt(1);
                        if(a>0){
                         out.println("This Name is exist, try another name !");   
                        }else{
                String query="insert into cost_name(COST_NAME) value (?)";
                ...
                int b = ps.executeUpdate();
                    if (b > 0) {
                        ...
                        out.println("Name is not entryed");
                    }
                        }
            } catch (Exception ex) {
              ex.printStackTrace();
