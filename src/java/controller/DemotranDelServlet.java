 ...
 * @author Acer
 */
public class DemotranDelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs1=null;
            ...
            try {
                ...
                String type="select TR_TYPE, REMARK, AMOUNT from demo_transaction where SI_NO=?";
                ...
                if(trtype.equals("Payment")){
             String query="insert into cash_debit(DEBIT_NAME, AMOUNT, DATE) values(?,?, CURDATE())";
             ps = con.prepareStatement(query);
             ps.setString(1, "Demo Payment return from" +remark);
             ps.setFloat(2, amount);
             int a = ps.executeUpdate();
             if(a>0){
                 String dquery = "delete from demo_transaction where SI_NO=? ";
            ...
            ps = con.prepareStatement(query);
             ps.setString(1, "Receive return from" +remark);
             ps.setFloat(2, amount);
             int a = ps.executeUpdate();
             if (a > 0) {
                String dquery = "delete from demo_transaction where SI_NO=? ";
