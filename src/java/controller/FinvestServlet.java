 ...
 * @author Acer
 */
public class FinvestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String investname=request.getParameter("invest");
       ...
       PreparedStatement ps=null;
        ...
        try{
            ...
            String query="insert into fixed_invest(FIXED_INVEST_NAME, AMOUNT, DATE) values(?,?, CURDATE())";
            ps = con.prepareStatement(query);
            ps.setString(1, investname);
