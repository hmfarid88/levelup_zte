...
//compose message
        try {
            ...
            message.setSubject("Data Backup From  levelup_zte");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Level Up\\Backup File\\levelup_zte.sql";
        
        String fileName = "levelup_zte.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Level Up\\Backup File\\levelup_zte.sql");
            f.delete();
