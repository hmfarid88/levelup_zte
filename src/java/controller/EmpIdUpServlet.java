 ...
 * @author Acer
 */
public class EmpIdUpServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                String update="update userinfo set USER_ID=?, PASSWORD=? where USER_TYPE='Employee' and PHONE_NUMBER=? and USER_ID=? and PASSWORD=?";
