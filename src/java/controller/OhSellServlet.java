 ...
 * @author Acer
 */
public class OhSellServlet extends HttpServlet {
                ...
                if (p < 1) {
                   out.println("<h3>Sorry! This Product is not in stock");
                    ...
                    rs1.next();
                        ...
                        Float hprice = rs1.getFloat("PURCHASE_PRICE");
                    ...
                    ps.setFloat(1, hprice-costprice);
                    ps.setString(2, ime);
                    ps.executeUpdate();
                          }
                        ...
                        if (b > 0) {
                            response.sendRedirect("symmobilesell_own.jsp");
                        } else {
